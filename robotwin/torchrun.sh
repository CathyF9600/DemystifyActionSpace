...
name=rel_qpos_cnt_mean
port=13536
output_dir=runnings/RoboTwin/chunk30/$name
...
torchrun --nproc-per-node=8 --nnodes=1 --node-rank=0 --master-addr=localhost --master-port=$port train.py \
    ...
    --train_metas_path /home/fyc/EmpiricalStudyForVLA/datasets/meta_files/rel_qpos_single_camera-50-10.jsonl \
